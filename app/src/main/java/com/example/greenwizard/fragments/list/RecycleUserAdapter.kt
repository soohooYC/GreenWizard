...
class RecycleUserAdapter : RecyclerView.Adapter<RecycleUserAdapter.MyViewHolder>() {
    ...
    override fun onBindViewHolder(holder: RecycleUserAdapter.MyViewHolder, position: Int) {
        ...
        holder.rowLayout.setOnClickListener{
            val action = list_recycle_userFragmentDirections.actionListRecycleUserFragmentToUpdateRecycleUserFragment(currentItem)
